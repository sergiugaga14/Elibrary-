                        ...
                        <div class="row">
                            <div class="col">
                                <center>  
                                    ...
                                    <asp:Label ID="Label1" runat="server" Text="Active" class="badge badge-pill badge-success"></asp:Label>
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            <div class="col-md-4">
                                 <label>User ID</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" placeholder="User ID" ID="TextBox1" runat="server" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                             <div class="col-md-4">
                                  <label>Old Password</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" placeholder="Password" ID="TextBox2" runat="server" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                             <div class="col-md-4">
            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>  
                                    ...
                                    <asp:Label ID="Label2" runat="server" Text="Info about due date" class="badge badge-pill badge-info"></asp:Label>
                        ...
                        <div class="row">
                            <div class="col">
                                <asp:GridView ID="GridView1" runat="server" class="table table-striped table-bordered" OnRowDataBound="GridView1_RowDataBound1"></asp:GridView>
                            </div>
                        </div>
