            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center> <img id="imgview" src="imgs/books.png" height="150px" width="100px" /></center>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" placeholder="Full Name" ID="TextBox4" runat="server"></asp:TextBox>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <label>Date</label>
                                <div class="form-group">
                                     <asp:TextBox  TextMode="Date" CssClass="form-control" ID="TextBox1" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-4">
                                  <label>Genre</label>
